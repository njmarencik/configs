...
local menu        = "wofi --show drun --width 300 --height 300"
local screenshot  = "grim -g \"$(slurp)\" - | tee ~/Screenshots/screenshot_$(date +%Y%m%d_%H%M%S).png | wl-copy"
...
hl.config({
    general = {
        ...
        col = {
            active_border   = "rgba(c25c73ff)",
            inactive_border = "rgba(35303dff)",
        },
...
hl.bind(mainMod .. " + SHIFT + C", hl.dsp.exec_cmd("command -v hyprshutdown >/dev/null 2>&1 && hyprshutdown || hyprctl dispatch 'hl.dsp.exit()'"))
